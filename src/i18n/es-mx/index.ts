...
export default {
  failed: 'Falló la acción', // 'Action failed',
  success: 'Fue exitosa la acción', // 'Action successful',
  oops: 'Algo no salió bien', //'Something went wrong: ',
  error403: 'No tienes los permisos para realizar esta acción. Por favor, contacta un administrador.', //'Hey you! You do not have the permissions for this action. Please contact the administrator.',
  error401: 'Por favor ingresa para hacer cualquier otra acción de ese tipo.', //'Hey you! Please log in to do any further actions of that type.',
  error404page: '¡Ups! No hay nada aquí...', //"Doh! There's nothing here...",
  error415: 'Sólamente se aceptan los archivos con el formato de codificación UTF-8. ', //'Hey you! Only files with UTF-8 encoding format are supported.',
  welcomeback: 'Bienvenido de nuevo a Arborator!',//'Welcome back to Arborator!',
  loginbtn: 'Ingresa', // 'Log in',
  loginselector: 'Conectar con', //'Connect via',
  switchLanguage: 'Cambiar el idioma del interfaz', //'Switch the language of the user interface',
  documentation: 'Ver la documentación', //'See the documantation',
  darkMode: 'Cambiar a modo oscuro', //'Toggle dark mode',
  projectAdmin: 'Tú eres administrador del proyecto', //'You are admin of this project',
  userInformation: 'Información del usuario', //'User information',
  settings: 'Configuración', //'Settings',
  admin: 'Admin',
  fullscreen: 'Pantalla completa', //'Fullscreen',
  navhome: 'Inicio', //'Home',
  navprojects: 'Proyectos', //'Projects',
  navsettings: 'Configuración', //'Settings',
  navklang: 'Klang',

  // confirm action dialog
  confirmAction: {
    title: 'Estás segure?', //'Are you sure?',
    message: 'Vas a realizar una acción irrevocable. ¿De veras quieres proceder?', //'You are about to perform an irrevocable action. Do you really want to proceed?',
  },

  // first page (the index)
  homepage: {
    accessTreebankBtn: 'Acceder a los bancos de arboles', //'Access Treebanks',
    slogan: 'Anotación de bancos de arboles para los seres humanos', //'Treebank Annotation for Human Beings',
    features: [
      'Anotar y compartir tus bancos de arboles', //'Annotate and Share your Treebanks',
      'Buscar utilizando gramáticas de vanguardia', //'Query and Search using State-of-the-art Grammars',
      'Libre y de código abierto', //'Free and Open Source',
  ...
  createProjectCard: {
    exerciseMode: 'modo de ejercicio',//'exercise mode',
  },

  // window which displays project settings
  projectSettings: {
    title: 'Configuración', //'Settings',
    windowClose: 'Cerrar', //'Close',
    descriptionSave: 'Gyardar descripción', //'Save description',
    togglePrivate: 'Visibilidad', //'Visibility',
